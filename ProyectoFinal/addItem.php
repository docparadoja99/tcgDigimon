...
<html>
	...
	<body>
        ...
        <header id="header" class="bar">
            <div class="logo"><a href="index.php">paradox shop</a></div>
			...
			<footer id="footer">
				<div class="container">
					<ul class="icons">
                    <li><a href="https://www.facebook.com/gerardo.rodriguezcampos" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
						<li><a href="https://www.instagram.com/docparadoja" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
					</ul>
				</div>
			</footer>
